	...
	<body>
		...
		<div id="show-event" class="content scaffold-show" role="main">
			...
			<ol class="property-list event">
				...
				<g:if test="${eventInstance?.groups}">
				<li class="fieldcontain">
					<span id="groups-label" class="property-label"><g:message code="event.groups.label" default="Groups" /></span>
					
						<g:each in="${eventInstance.groups}" var="g">
